 ...
 * {@link com.uxplima.uxmlib.command.annotation.annotations.Permission} to gate a branch, and
 * {@link com.uxplima.uxmlib.command.annotation.annotations.PlayerOnly} to require a player sender. The
 * reflection that reads them and builds the Brigadier tree lives one package up in
